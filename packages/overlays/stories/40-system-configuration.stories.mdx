...
### Backdrop for placementMode: local

We provide a possibility to add a backdrop to a locally placed overlay as well.

<Story name="hasBackdrop local">
  {() => html`
    <demo-overlay-system
